...
export const DONATION_STATE_TRANSACTIONS: Record<DONATION_STATE, DONATION_STATE[]> = {
    ...
    READY_TO_TRAVEL: [DONATION_STATE.CREATED, DONATION_STATE.PENDING_TO_COLLECT, DONATION_STATE.CANCELLED],
    PENDING_TO_COLLECT: [DONATION_STATE.READY_TO_TRAVEL, DONATION_STATE.IN_TRAVEL, DONATION_STATE.CANCELLED],
    CANCELLED: [],
